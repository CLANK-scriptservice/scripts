...
if not getgenv().clankHUB or getgenv().clankHUB.Aimbot then return end
...
local Environment = getgenv().clankHUB.Aimbot
...
function Environment.Functions:Exit()
	...
	getgenv().clankHUB.Aimbot.Functions = nil
	getgenv().clankHUB.Aimbot = nil
