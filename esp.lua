...
if not getgenv().clankHUB or getgenv().clankHUB.WallHack then return end
...
local Environment = getgenv().clankHUB.WallHack
...
function Environment.Functions:Exit()
	...
	getgenv().clankHUB.WallHack.Functions = nil
	getgenv().clankHUB.WallHack = nil
